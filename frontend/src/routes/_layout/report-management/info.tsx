    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Complete reference for integrating report generation with ToolJet,
          external systems, and custom applications.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Use client credentials (client_id + client_secret) to obtain a JWT
            token. Clients are managed in System → Clients, and must be assigned
            to report modules.
          </CardDescription>
        </CardHeader>
...
Authorization: Bearer eyJhbGciOi...`}
          ...
          <div className="text-sm text-muted-foreground space-y-1">
            ...
            <p>
              1. Create a client in <strong>System → Clients</strong>
            </p>
            <p>
              2. Assign the report module to the client (Report Modules field in
              client edit page)
            </p>
            <p>
              3. The client can then generate reports for all templates in
              assigned modules
            </p>
          </div>
        </CardContent>
...
→ { output_url: "..." }`}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            All endpoints use POST method and require dashboard JWT token
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell className="text-sm">
                  List modules (paginated, filter by name/status)
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
                ...
                <TableCell className="font-mono text-xs">
                  /api/v1/report-modules/create
                </TableCell>
                <TableCell className="text-sm">
                  Create module (name, minio_datasource_id, sql_datasource_id,
                  buckets)
                </TableCell>
              </TableRow>
              <TableRow>
                ...
                <TableCell className="font-mono text-xs">
                  /api/v1/report-modules/{"{id}"}
                </TableCell>
                <TableCell className="text-sm">
                  Module detail with templates list and client IDs
                </TableCell>
              </TableRow>
              ...
              <TableRow>
                ...
                <TableCell className="text-sm">
                  List all templates (global, filter by module_id/name/status)
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
                ...
                <TableCell className="font-mono text-xs">
                  /api/v1/report-modules/{"{mid}"}/templates/create
                </TableCell>
                <TableCell className="text-sm">
                  Create template with optional inline sheet_mappings
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
                ...
                <TableCell className="font-mono text-xs">
                  /api/v1/report-modules/{"{mid}"}/templates/{"{tid}"}
                </TableCell>
                <TableCell className="text-sm">
                  Template detail with sheet mappings
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
                ...
                <TableCell className="font-mono text-xs">
                  /api/v1/report-modules/{"{mid}"}/templates/update
                </TableCell>
                <TableCell className="text-sm">
                  Update template (body contains id)
                </TableCell>
              </TableRow>
              ...
              <TableRow>
                ...
                <TableCell className="text-sm">
                  Add mapping (sheet_name, start_cell, sql_content, write_mode,
                  write_headers)
                </TableCell>
              </TableRow>
              <TableRow>
                ...
                <TableCell className="text-sm">
                  Update mapping (body contains id)
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
              ...
              <TableRow>
                ...
                <TableCell className="font-mono text-xs">
                  /api/v1/report-modules/{"{mid}"}/templates/{"{tid}"}/generate
                </TableCell>
                <TableCell className="text-sm">
              ...
              <TableRow>
                ...
                <TableCell className="font-mono text-xs">
                  /api/v1/report-executions/{"{exec_id}"}
                </TableCell>
                <TableCell className="text-sm">
                  Get execution detail (poll for async status)
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
                ...
                <TableCell className="font-mono text-xs">
                  /api/v1/report-executions?module_id=&status=
                </TableCell>
                <TableCell className="text-sm">
                  Global execution list with filters
                </TableCell>
              </TableRow>
              ...
              <TableRow>
                ...
                <TableCell className="font-mono text-xs">
                  /api/v1/report-modules/buckets/{"{datasource_id}"}
                </TableCell>
              ...
              <TableRow>
                ...
                <TableCell className="font-mono text-xs">
                  /api/v1/report-modules/files/{"{datasource_id}"}/{"{bucket}"}
                </TableCell>
                <TableCell className="text-sm">
                  List .xlsx files in a bucket
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>
                ...
                <TableCell className="font-mono text-xs">
                  /api/v1/report-modules/sheets/{"{datasource_id}"}/{"{bucket}"}
                  /{"{path}"}
                </TableCell>
                <TableCell className="text-sm">
                  List sheet names from an .xlsx file
                </TableCell>
              </TableRow>
            </TableBody>
          </Table>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            The most important endpoint for integration
          </CardDescription>
        </CardHeader>
  ...
  "completed_at": "2026-04-04T10:00:03"
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell className="text-sm">
                    Key-value params passed to SQL Jinja2 templates
                  </TableCell>
                </TableRow>
                <TableRow>
                  ...
                  <TableCell className="text-sm">
                    If true, returns immediately with execution_id for polling
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Step-by-step guide for calling report APIs from ToolJet
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-3">
            <div className="border rounded-lg p-4">
              ...
              <div className="text-sm text-muted-foreground space-y-1">
                <p>
                  a. Create a client in <strong>System → Clients</strong> (e.g.
                  client_id:{" "}
                  <code className="bg-muted px-1 rounded">tooljet-app</code>)
                </p>
                <p>
                  b. Assign the report module to this client (edit client →
                  Report Modules)
                </p>
                <p>
                  c. Note down the{" "}
                  <code className="bg-muted px-1 rounded">client_id</code> and{" "}
                  <code className="bg-muted px-1 rounded">client_secret</code>
                </p>
              </div>
            </div>
            ...
            <div className="border rounded-lg p-4">
              <h4 className="font-medium mb-2">
                2. Create REST API Datasource in ToolJet
              </h4>
              <Table>
                <TableBody>
                  <TableRow>
  ...
  "client_secret": "your-secret"
              ...
              <p className="text-xs text-muted-foreground mt-2">
                ...
                <code className="bg-muted px-1 rounded">
                  {"{{queries.getToken.data.access_token}}"}
                </code>
              </p>
            </div>
            ...
            <div className="border rounded-lg p-4">
              <h4 className="font-medium mb-2">
                4. Create Query: Generate Report
              </h4>
              <Table>
                <TableBody>
                  <TableRow>
                  ...
                  <TableRow>
                    <TableHead>URL</TableHead>
                    <TableCell className="font-mono text-xs">
                      /api/v1/report-modules/{"{module_id}"}/templates/
    ...
    "month": "{{components.monthPicker.value}}"
            ...
            <div className="border rounded-lg p-4">
              ...
              <p className="text-sm text-muted-foreground mb-2">
                Use{" "}
                <code className="bg-muted px-1 rounded">
                  {"{{queries.generateReport.data.output_url}}"}
                </code>{" "}
                in a Link or Button component to download the file.
              </p>
              <pre className="bg-muted rounded p-2 text-xs">
...
// Open in new tab: true`}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Full example with inline sheet mappings
          </CardDescription>
        </CardHeader>
        <CardContent>
          <pre className="bg-muted rounded-md p-4 overflow-x-auto text-xs font-mono whitespace-pre">
      ...
      },
      {
        ...
        "sort_order": 2
          ...
          <div className="mt-4 text-sm text-muted-foreground space-y-1">
            <p>
              <strong>template_path:</strong> Path to .xlsx file in module's
              default template bucket. Empty = blank workbook.
            </p>
            <p>
              <strong>output_prefix:</strong> Prefix for generated files in
              module's default output bucket.
            </p>
            <p>
              <strong>recalc_enabled:</strong> Run LibreOffice to recalculate
              formulas before extracting output sheet.
            </p>
            <p>
              <strong>output_sheet:</strong> Extract only this sheet (values +
              format). Requires recalc. Empty = return full file.
            </p>
            <p>
              <strong>write_mode:</strong> <code>rows</code> (default) writes
              all query rows, <code>single</code> writes first cell only.
            </p>
            <p>
              <strong>sql_content:</strong> Jinja2 SQL template. Parameters from
              generate request are available as {"{{ param_name }}"}.
            </p>
          </div>
        </CardContent>
      </Card>
