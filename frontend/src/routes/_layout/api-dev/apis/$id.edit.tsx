...
function ApiEdit() {
  ...
  useEffect(() => {
    if (apiDetail) {
      ...
      let params: Array<{ name: string; location: "query" | "header" | "body"; data_type?: string | null; is_required?: boolean; validate_type?: "regex" | "python" | null; validate?: string | null }> = []
      ...
      form.reset({
        ...
        datasource_id: apiDetail.datasource_id ? String(apiDetail.datasource_id) : null,
