                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        Max requests per minute for this client. Empty = no
                        limit.
                      </p>
                      <FormMessage />
                    </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        Max requests in flight for this client. Empty = use
                        global default.
                      </p>
                      <FormMessage />
                    </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        JWT token lifetime in seconds (60–86400). Empty = use
                        global default.
                      </p>
                      <FormMessage />
                    </FormItem>
                            ...
                            <div className="flex min-h-[40px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 cursor-pointer">
                              <div className="flex flex-wrap gap-1 flex-1">
                                {field.value && field.value.length > 0 ? (
                                  ...
                                  <span className="text-muted-foreground">
                                    Select direct APIs (client can call even if
                                    not in a group)...
                                  </span>
                                )}
                              </div>
